...
function createWithBsPrefix(prefix, {
  ...
  BsComponent.defaultProps = defaultProps39;
...
function useUpdateEffect(fn, deps) {
  var isFirst = (0, import_react22.useRef)(true);
...
var Carousel = React33.forwardRef((uncontrolledProps, ref) => {
  const {
    // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
    as: Component2 = "div",
    bsPrefix,
...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  ...
  return [isProp2 ? propValue : stateValue, (0, import_react27.useCallback)((value, ...args) => {
    if (handler)
      handler(value, ...args);
    setState(value);
  }, [handler])];
...
function useForceUpdate() {
  var _useReducer = (0, import_react28.useReducer)(function(state) {
    return !state;
...
var $704cf1d3b684cc5c$var$SSRContext = (0, import_react29.default).createContext($704cf1d3b684cc5c$var$defaultContext);
function $704cf1d3b684cc5c$export$9f8ac96af4b1b2ae(props) {
  let cur = (0, import_react29.useContext)($704cf1d3b684cc5c$var$SSRContext);
  let counter = $704cf1d3b684cc5c$var$useCounter(cur === $704cf1d3b684cc5c$var$defaultContext);
  let [isSSR, setIsSSR] = (0, import_react29.useState)(true);
  let value = (0, import_react29.useMemo)(() => ({
  ...
  return (0, import_react29.default).createElement($704cf1d3b684cc5c$var$SSRContext.Provider, {
    value
  }, props.children);
}
...
function $704cf1d3b684cc5c$var$useCounter(isDisabled = false) {
  let ctx = (0, import_react29.useContext)($704cf1d3b684cc5c$var$SSRContext);
...
function useDropdownToggle() {
  ...
  const {
    ...
    setToggle,
    menuElement
  } = (0, import_react30.useContext)(DropdownContext_default) || {};
  const handleClick = (0, import_react30.useCallback)((e) => {
    toggle(!show, e);
  }, [show, toggle]);
  const props = {
    id,
...
function useDropdownItem({
  ...
  const navContext = (0, import_react31.useContext)(NavContext_default);
  const {
    activeKey
  } = navContext || {};
...
var Context = (0, import_react32.createContext)(canUseDOM_default ? window : void 0);
var WindowProvider = Context.Provider;
function useWindow() {
  return (0, import_react32.useContext)(Context);
}
...
function useRefWithUpdate() {
  ...
  const attachRef = (0, import_react33.useCallback)((element) => {
    ref.current = element;
    forceUpdate();
  }, [forceUpdate]);
...
function Dropdown({
  ...
  const lastSourceEvent = (0, import_react33.useRef)(null);
  const focusInDropdown = (0, import_react33.useRef)(false);
  const onSelectCtx = (0, import_react33.useContext)(SelectableContext_default);
  const toggle = (0, import_react33.useCallback)((nextShow, event, source = event == null ? void 0 : event.type) => {
    onToggle(nextShow, {
      originalEvent: event,
      source
    });
  ...
  const context4 = (0, import_react33.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
  ...
  useEventListener((0, import_react33.useCallback)(() => window2.document, [window2]), "keydown", (event) => {
...
var DropdownToggle2 = React41.forwardRef(({
  bsPrefix,
  split,
  className,
  childBsPrefix,
...
var DropdownButton = React43.forwardRef(({
  title,
  children,
  bsPrefix,
  rootCloseEvent,
...
var Feedback = React44.forwardRef(
  ...
  ({
    ...
    tooltip = false,
    ...props
  }, ref) => (0, import_jsx_runtime40.jsx)(Component2, {
    ...props,
    ref,
...
var FormCheckLabel = React47.forwardRef(({
  ...
  return (0, import_jsx_runtime42.jsx)("label", {
    ...props,
    ref,
...
var FormCheck = React48.forwardRef(({
  ...
  const input = (0, import_jsx_runtime43.jsx)(FormCheckInput_default, {
    ...props,
...
var FormGroup = React50.forwardRef(({
  controlId,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "div",
  ...props
...
FormLabel.defaultProps = defaultProps14;
...
var FormRange = React52.forwardRef(({
  bsPrefix,
  className,
  id,
  ...props
...
var FormSelect = React53.forwardRef(({
  bsPrefix,
  size: size2,
  htmlSize,
  className,
...
var FormText = React54.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    bsPrefix,
    className,
...
var Switch = React55.forwardRef((props, ref) => (0, import_jsx_runtime52.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var FloatingLabel = React56.forwardRef(({
  bsPrefix,
  className,
  children,
  controlId,
...
var propTypes5 = {
   ...
   */
  fluid: import_prop_types7.default.bool,
  /**
   * Sets image shape as rounded.
   */
  rounded: import_prop_types7.default.bool,
  /**
   * Sets image shape as circle.
   */
  roundedCircle: import_prop_types7.default.bool,
  /**
   * Sets image shape as thumbnail.
   */
  thumbnail: import_prop_types7.default.bool
};
var defaultProps16 = {
  fluid: false,
  rounded: false,
...
FigureImage.defaultProps = defaultProps17;
...
var InputGroup = React61.forwardRef(({
  bsPrefix,
  size: size2,
  hasValidation,
  className,
...
function useNavItem({
  ...
  const parentOnSelect = (0, import_react45.useContext)(SelectableContext_default);
  const navContext = (0, import_react45.useContext)(NavContext_default);
  const tabContext = (0, import_react45.useContext)(TabContext_default);
  let isActive = active;
  const props = {
    role
  };
...
var Nav = React64.forwardRef((_ref, ref) => {
  ...
  const forceUpdate = useForceUpdate();
  const needsRefocusRef = (0, import_react46.useRef)(false);
  ...
  const listNode = (0, import_react46.useRef)(null);
...
function NoopTransition({
  ...
  const child = (0, import_react48.cloneElement)(children, {
    ref: combinedRef
  });
  if (inProp)
    return child;
...
var Modal = (0, import_react50.forwardRef)((_ref, ref) => {
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime65.jsx)("div", Object.assign({}, dialogProps, {
    children: React68.cloneElement(children, {
      role: "document"
    })
  }));
  ...
  return (0, import_jsx_runtime65.jsx)(import_jsx_runtime66.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime67.jsxs)(import_jsx_runtime66.Fragment, {
...
var ModalContext = React69.createContext({
...
var ModalDialog = React70.forwardRef(({
  bsPrefix,
  className,
  contentClassName,
  centered,
...
var AbstractModalHeader = React71.forwardRef(({
  closeLabel,
  closeVariant,
  closeButton,
  onHide,
  ...
  return (0, import_jsx_runtime70.jsxs)("div", {
    ref,
    ...props,
    children: [children, closeButton && (0, import_jsx_runtime69.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick
    })]
...
AbstractModalHeader.defaultProps = defaultProps18;
...
var ModalHeader = React72.forwardRef(({
  bsPrefix,
  className,
  ...props
}, ref) => {
...
ModalHeader.defaultProps = defaultProps19;
...
var Modal2 = React73.forwardRef(({
  ...
  const renderBackdrop = (0, import_react52.useCallback)((backdropProps) => (0, import_jsx_runtime72.jsx)("div", {
    ...backdropProps,
...
Modal2.defaultProps = defaultProps20;
...
var NavLink = React74.forwardRef(({
  bsPrefix,
  className,
  as: Component2 = Anchor_default,
  active,
  ...
  return (0, import_jsx_runtime73.jsx)(Component2, {
    ...
    ...navItemProps,
    ref,
    className: (0, import_classnames48.default)(className, bsPrefix, props.disabled && "disabled", meta.isActive && "active")
  });
});
NavLink.displayName = "NavLink";
NavLink.defaultProps = defaultProps21;
...
var Nav2 = React75.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
    bsPrefix: initialBsPrefix,
    variant,
...
Nav2.defaultProps = defaultProps22;
...
var NavbarBrand = React76.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React77.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
...
var NavbarToggle = React78.forwardRef(({
  bsPrefix,
  className,
  children,
  label,
...
NavbarToggle.defaultProps = defaultProps23;
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    var query = (0, import_react57.useMemo)(function() {
...
OffcanvasToggling.defaultProps = defaultProps24;
...
OffcanvasHeader.defaultProps = defaultProps25;
...
function DialogTransition2(props) {
  return (0, import_jsx_runtime80.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
function BackdropTransition2(props) {
  return (0, import_jsx_runtime80.jsx)(Fade_default, {
    ...props
  });
}
var Offcanvas = React81.forwardRef(({
  ...
  const modalManager = (0, import_react58.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const {
    onToggle
  } = (0, import_react58.useContext)(NavbarContext_default) || {};
  const [showOffcanvas, setShowOffcanvas] = (0, import_react58.useState)(false);
  ...
  const renderBackdrop = (0, import_react58.useCallback)((backdropProps) => (0, import_jsx_runtime80.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames54.default)(`${bsPrefix}-backdrop`, backdropClassName)
  }), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime80.jsx)("div", {
    ...dialogProps,
    ...props,
  ...
  return (0, import_jsx_runtime82.jsxs)(import_jsx_runtime81.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime80.jsx)(ModalContext_default.Provider, {
      value: modalContext,
      children: (0, import_jsx_runtime80.jsx)(Modal_default, {
        show: showOffcanvas,
        ref,
        backdrop,
        container,
...
Offcanvas.defaultProps = defaultProps26;
...
var NavbarOffcanvas = React82.forwardRef((props, ref) => {
  const context4 = (0, import_react59.useContext)(NavbarContext_default);
...
var Navbar = React83.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand,
    variant,
  ...
  const handleCollapse = (0, import_react60.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react60.useMemo)(() => ({
    onToggle: () => onToggle == null ? void 0 : onToggle(!expanded),
    bsPrefix,
    expanded: !!expanded,
    expand
  }), [bsPrefix, expanded, expand, onToggle]);
  return (0, import_jsx_runtime84.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
...
Navbar.defaultProps = defaultProps27;
...
var NavDropdown = React84.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
  ...
  return (0, import_jsx_runtime86.jsxs)(Dropdown_default2, {
    ...
    children: [(0, import_jsx_runtime85.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
...
var Overlay = React85.forwardRef((props, outerRef) => {
  ...
  const [exited, setExited] = (0, import_react62.useState)(!props.show);
...
var Popover = React87.forwardRef(({
  bsPrefix,
  placement,
  className,
  style: style2,
  ...
  return (0, import_jsx_runtime88.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime87.jsx)("div", {
      ...
      ...arrowProps
    }), body ? (0, import_jsx_runtime87.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
Popover.defaultProps = defaultProps28;
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react63.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
...
var Overlay2 = React88.forwardRef(({
  children: overlay,
  transition,
  popperConfig = {},
  ...outerProps
}, outerRef) => {
  const popperRef = (0, import_react64.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react64.useState)(null);
  ...
  return (0, import_jsx_runtime89.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React88.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper,
...
Overlay2.defaultProps = defaultProps29;
...
function OverlayTrigger({
  ...
  const triggerNodeRef = (0, import_react65.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, children.ref);
  const timeout2 = useTimeout();
  const hoverStateRef = (0, import_react65.useRef)("");
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React89.Children.only(children).props : {};
  const attachRef = (r) => {
    mergedRef(safeFindDOMNode(r));
  };
  const handleShow = (0, import_react65.useCallback)(() => {
    timeout2.clear();
  ...
  const handleHide = (0, import_react65.useCallback)(() => {
    timeout2.clear();
  ...
  const handleFocus = (0, import_react65.useCallback)((...args) => {
    handleShow();
    onFocus == null ? void 0 : onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react65.useCallback)((...args) => {
    handleHide();
    onBlur == null ? void 0 : onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react65.useCallback)((...args) => {
    setShow(!show);
    onClick == null ? void 0 : onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react65.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react65.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime92.jsxs)(import_jsx_runtime91.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react65.cloneElement)(children, triggerProps), (0, import_jsx_runtime90.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
OverlayTrigger.defaultProps = defaultProps30;
...
var PageItem = React90.forwardRef(({
  active,
  disabled,
  className,
  style: style2,
...
PageItem.defaultProps = defaultProps31;
PageItem.displayName = "PageItem";
var PageItem_default = PageItem;
function createButton(name, defaultValue, label = name) {
  const Button3 = React90.forwardRef(({
    children,
    ...props
...
var Pagination = React91.forwardRef(({
  bsPrefix,
  className,
  size: size2,
  ...props
...
var PlaceholderButton = React92.forwardRef((props, ref) => {
...
var Placeholder = React93.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
var ProgressBar = React94.forwardRef(({
  isChild,
  ...props
}, ref) => {
  ...
  return (0, import_jsx_runtime98.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react66.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min,
      now,
...
ProgressBar.defaultProps = defaultProps32;
...
var Ratio = React95.forwardRef(({
  ...
  return (0, import_jsx_runtime99.jsx)("div", {
    ...
    children: React95.Children.only(children)
  });
});
Ratio.defaultProps = defaultProps33;
...
var Spinner = React97.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size: size2,
...
var SplitButton = React98.forwardRef(({
  id,
  bsPrefix,
  size: size2,
  variant,
...
var TabPanel = React100.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
    ...
    return (0, import_jsx_runtime105.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime105.jsx)(SelectableContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime105.jsx)(Transition2, {
          in: isActive,
          onEnter,
          onEntering,
          onEntered,
...
var TabPane = React103.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
  ...
  return (0, import_jsx_runtime108.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime108.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime108.jsx)(Transition2, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
...
var Tab = () => {
  ...
  return (0, import_jsx_runtime110.jsx)(import_jsx_runtime109.Fragment, {});
};
...
var Table = React105.forwardRef(({
  ...
  const table = (0, import_jsx_runtime111.jsx)("table", {
    ...props,
    className: classes,
    ref
  });
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime112.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime112.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime113.jsxs)(Tabs_default, {
    id,
    activeKey,
    onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime112.jsx)(Nav_default2, {
      ...controlledProps,
      role: "tablist",
      as: "ul",
      children: map(children, renderTab)
    }), (0, import_jsx_runtime112.jsx)(TabContent_default, {
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime112.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
Tabs2.defaultProps = defaultProps35;
...
var ToastFade = React107.forwardRef((props, ref) => (0, import_jsx_runtime114.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React108.createContext({
  // eslint-disable-next-line @typescript-eslint/no-empty-function
  onClose() {
  }
});
...
var ToastHeader = React109.forwardRef(({
  bsPrefix,
  closeLabel,
  closeVariant,
  closeButton,
  ...
  const context4 = (0, import_react69.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
  ...
  return (0, import_jsx_runtime116.jsxs)("div", {
    ...
    children: [children, closeButton && (0, import_jsx_runtime115.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick,
      "data-dismiss": "toast"
...
ToastHeader.defaultProps = defaultProps36;
...
var Toast = React110.forwardRef(({
  ...
  const delayRef = (0, import_react70.useRef)(delay);
  const onCloseRef = (0, import_react70.useRef)(onClose);
  ...
  const autohideFunc = (0, import_react70.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react70.useMemo)(() => ({
    onClose
  }), [onClose]);
  ...
  return (0, import_jsx_runtime117.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition2 ? (0, import_jsx_runtime117.jsx)(Transition2, {
      in: show,
      unmountOnExit: true,
      children: toast
    }) : toast
...
var ToastContainer = React111.forwardRef(({
  bsPrefix,
  position,
  ...
  return (0, import_jsx_runtime118.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames71.default)(bsPrefix, position && [containerPosition ? `position-${containerPosition}` : null, positionClasses[position]], className)
  });
});
...
var noop5 = () => void 0;
var ToggleButton = React112.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
...
var ToggleButtonGroup = React113.forwardRef((props, ref) => {
  const {
    children,
    type,
    name,
...
ToggleButtonGroup.defaultProps = defaultProps37;
...
var Tooltip = React114.forwardRef(({
  bsPrefix,
  placement,
  className,
  style: style2,
...
Tooltip.defaultProps = defaultProps38;
